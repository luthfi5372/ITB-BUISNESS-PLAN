...
export default function KonselingPage() {
  return (
    <div className="p-6 space-y-6">
      <div>
        <p className="text-[10px] font-black uppercase tracking-widest text-theme-primary mb-1">Konsultasi Profesional</p>
        <h2 className="text-2xl font-black italic uppercase tracking-tighter">Psikolog & Konselor</h2>
      </div>

      {/* Upcoming */}
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}
        className="bg-gradient-to-br from-theme-primary/20 to-violet-600/10 border border-theme-primary/20 rounded-3xl p-6"
      >
        <p className="text-[10px] font-black uppercase tracking-widest text-theme-primary mb-4">Sesi Berikutnya</p>
        <div className="flex items-center gap-4">
          <div className="w-14 h-14 bg-theme-primary/30 rounded-2xl flex items-center justify-center text-2xl font-black text-theme-primary">S</div>
          <div className="flex-1">
            ...
            <p className="text-[10px] text-theme-primary font-black uppercase tracking-widest mt-1">📅 Besok, 15.00 WIB</p>
          </div>
          <button className="px-5 py-2.5 bg-theme-primary hover:bg-theme-primary text-white font-black text-[9px] uppercase tracking-widest rounded-xl transition-all">
            Masuk
          </button>
        </div>
      </motion.div>
      ...
      <div className="space-y-4">
        {doctors.map((doc, i) => (
          ...
          >
            <div className="w-14 h-14 bg-gradient-to-br from-theme-primary/30 to-rose-500/30 rounded-2xl flex items-center justify-center text-xl font-black text-white shrink-0">
              {doc.name.charAt(3)}
            </div>
            ...
            <button className="flex items-center gap-2 px-4 py-2.5 bg-theme-primary/20 hover:bg-theme-primary text-theme-primary hover:text-white font-black text-[9px] uppercase tracking-widest rounded-xl transition-all border border-theme-primary/20 shrink-0">
