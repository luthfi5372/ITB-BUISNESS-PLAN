      ...
      <AnimatePresence mode="wait">
        ...
        {step === 1 && (
          <motion.div key="step1" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0, scale: 1.1 }} className="text-center z-10">
            <div className="w-24 h-24 bg-indigo-600 rounded-[2rem] flex items-center justify-center mx-auto mb-8 shadow-2xl shadow-indigo-500/20">
        ...
        {step === 3 && (
          <motion.div key="step3" initial={{ opacity: 0, scale: 0.5 }} animate={{ opacity: 1, scale: 1 }} exit={{ opacity: 0 }} className="text-center z-10">
            <motion.div animate={{ rotate: [0, 10, -10, 0] }} transition={{ repeat: Infinity, duration: 2 }} className="w-32 h-32 bg-gradient-to-tr from-indigo-500 to-purple-500 rounded-[2.5rem] flex items-center justify-center mx-auto mb-8 shadow-[0_0_50px_rgba(99,102,241,0.4)]">
              <Trophy size={64} className="text-white" />
            </motion.div>
            <h2 className="text-white text-5xl font-black tracking-tighter italic shadow-lg">BONUS +100 EXP!</h2>
            <p className="text-indigo-300 mt-3 font-bold uppercase tracking-[0.3em] text-xs">Quest Pertama Dimulai</p>
          </motion.div>
        )}
        ...
        {step === 4 && (
          ...
          >
            ...
            <div className="flex justify-between items-center mb-12 border-b border-white/10 pb-8">
              ...
              <div className="text-center bg-indigo-600 p-6 rounded-3xl shadow-xl shadow-indigo-500/10">
                <p className="text-[10px] font-black text-indigo-100 uppercase tracking-widest">Current Level</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
              ...
              <div className="bg-white/5 p-8 rounded-3xl border border-white/10 space-y-4">
                ...
                <div className="h-3 bg-slate-800 rounded-full overflow-hidden"><div className="h-full bg-indigo-500 w-[40%] rounded-full shadow-lg shadow-indigo-500/50"></div></div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
              <div className="bg-indigo-600/10 p-8 rounded-3xl border border-indigo-500/20 flex items-center gap-6">
                <MessageSquareText size={40} className="text-indigo-400 flex-shrink-0" />
                <div>
                  <h4 className="font-bold text-white text-lg">Mira Chatbot Aktif</h4>
                  <p className="text-sm text-indigo-200 mt-1">Mira siap mendengarkan ceritamu 24/7. Mulai chat untuk +20 EXP.</p>
                </div>
              </div>
            ...
            <button
              ...
              className="w-full bg-indigo-600 text-white py-6 rounded-2xl font-black text-sm flex items-center justify-center gap-3 hover:bg-indigo-500 transition-all shadow-xl shadow-indigo-500/20 active:scale-[0.98]"
            >
