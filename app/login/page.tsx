    ...
    <div className="min-h-screen bg-[#050508] text-white flex items-center justify-center px-4 relative overflow-hidden">
      ...
      >
        ...
        <div className="text-center mb-10">
          ...
          <p className="mt-4 text-slate-400 text-sm font-medium italic">Selamat kembali, Warrior! 🌙</p>
        </div>

        {/* Card */}
        <div className="bg-white/5 backdrop-blur-3xl border border-white/10 rounded-[3rem] p-10 shadow-2xl">
          <h1 className="text-3xl font-black italic uppercase tracking-tighter mb-8 text-white">Masuk</h1>
          ...
          <div className="space-y-5">
            ...
            <div className="relative flex items-center py-2">
              ...
              <span className="flex-shrink-0 mx-4 text-white/30 text-xs font-medium">Bisa juga tanpa daftar</span>
              <div className="flex-grow border-t border-white/10"></div>
            </div>
            ...
            <div className="grid grid-cols-3 gap-3">
              <motion.button 
                ...
                className="py-3 bg-white/5 border border-white/10 hover:bg-white/10 rounded-xl flex justify-center items-center transition-all"
              >
                {/* Google Icon SVG */}
